...
function Konsultasi() {
  ...
  const [modalClass, setModalClass] = useState("modal-close");
    ...
    const handlePopupChoice = (choice) => {
      if (popupCount === 0) {
        ...
        setRedirectTo(choice === 'bank1' ? '/page1' : '/page2');
      }
    };
  ...
  const services = [
    ...
    { id: 2, name: 'Panggilan Suara 1 Jam', price: 'Rp 50.000', img: '/images/CALL.png' },
    { id: 3, name: 'Panggilan Video 1 Jam', price: 'Rp 70.000', img: '/images/VCALL.png' }
  ];

  const vouchers = [
    { id: 1, description: 'Diskon Rp5.000', expiry: '08 Mei 2024', img: '/images/Voucher.png' },
    { id: 2, description: 'Diskon Rp3.000', expiry: '08 Mei 2024', img: '/images/Voucher.png' }
  ];
    ...
    <main className="max-w-screen-xl mx-auto px-4 md:px-6 font-Poppins">
      ...
      <div className="flex justify-between items-center py-20">
        <div className="w-1/3 flex flex-col items-left">
          <img src="/images/FOTO.png" alt="Doctor" className=" h-full rounded-full" />
          ...
          <div className="flex items-left space-x-2 mt-2">
            <img src="/images/medical.png" alt="Icon" className="w-6 h-6 items-left" />
            <span>7 Tahun</span>
          </div>
        ...
        <div className="w-2/3 flex space-x-16 py-20">
          <div className="w-full">
            ...
            <div className="mt-2 space-y-4">
              ...
              <button className="mt-4 px-8 py-2 bg-primary-text text-white rounded-lg w-full" onClick={handlePaymentClick}>Pesan</button>
            ...
            <div className="mt-2 space-y-4">
                ...
                >
                  <div className="flex justify-between items-center">
                    <span className="flex items-center space-x-2">
                      <img src={service.img} alt={service.name} className="w-6 h-6" />
              ...
              <div className="mt-2 space-y-4">
                {vouchers.map((voucher) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span className="flex items-center space-x-2">
                        <img src={voucher.img} alt={voucher.description} className="w-6 h-6" />
              ...
              <div className="mt-2 bg-gray-100 p-4 rounded-lg shadow-md">
                ...
                <div className="flex items-center mt-2">
                  <img src="/images/user.png" alt="User" className="w-10 h-10 rounded-full mr-4" />
                  <p>Dokter yang hebat dan ramah. Saya sangat merasa cocok berkonsultasi.</p>
                </div>
              </div>
            </div>
          </div>
